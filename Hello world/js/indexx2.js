...
(function () {
  $.ajax({
    ...
    success: function (data1) {
      ...
      // 实例化对象
      let myChart = echarts.init(document.querySelector('.new'));
      // 指定配置项和数据
      let option = {
        color: ["#2f89cf"],
        // 提示框组件
...
(function () {
  $.ajax({
    ...
    dataType: 'json',
    success: function (data1) {
      let myChart = echarts.init(document.querySelector(".new3"));
...
(function () {
  $.ajax({
    ...
    dataType: 'json',
    success: function (data1) {
      let myChart = echarts.init(document.querySelector('.new1'))
      option = {
        color: ["#00f2f1", "#ed3f35"],
        tooltip: {
          trigger: 'axis'
...
(function () {
  $.ajax({
    ...
    dataType: 'json',
    success: function (data1) {
      let myChart = echarts.init(document.querySelector('.new4'))
      option = {
        tooltip: {
          trigger: 'axis',
        },
...
(function () {
  $.ajax({
    ...
    dataType: 'json',
    success: function (data1) {
      let myChart = echarts.init(document.querySelector('.new2'))
      option = {
        tooltip: {
          trigger: 'item',
...
(function () {
  $.ajax({
    ...
    dataType: 'json',
    success: function (data1) {
      let myChart = echarts.init(document.querySelector('.new5'))
      option = {
        color: [
          "#006cff",
          "#60cda0",
